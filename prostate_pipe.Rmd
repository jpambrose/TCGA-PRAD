...
```{r}
#removing single race plates A33R and A32Y
tfplate<- substr(cprad7$X3,22,25) %in% c("A33R","A32Y")
sum(tfplate)
```
...
gleasonpcexint.m<-mlogit(riskrecode ~  1 | PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 +PC20 +PC21+racerecode + age_centered +
                         (PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 +PC20 +PC21)*(racerecode + age_centered), data=gleasonpcexint.d2, reflevel = 1)
...
youngold.m3<-glm(youngoldrecode ~ PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 +PC20 +PC21+ racerecode + (PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 +PC20 +PC21) * racerecode, family = "binomial", data=pcaindv4)
summary(youngold.m3)

#age continuous models\
youngold.m<-lm(agedx ~ PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19+PC20 +PC21, data=pcaindv4)
summary(youngold.m)
...
youngold.m2<-lm(agedx ~ PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 + racerecode + (PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19) * racerecode, data=pcaindv4)
summary(youngold.m2)
```
...
ajcc.n.m3<-glm(ajcc.n.recode ~ PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 +PC20 +PC21+ racerecode +age_centered + (PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19 +PC20 +PC21) * (racerecode +age_centered), family = "binomial", data=pcaindv4)
summary(ajcc.n.m3)
```
...
print("age")
for (i in 1:21) {
  print(summary(aov(pcaindv5[,(i+2)] ~ pcaindv5$age_centered, data=pcaindv5)))
}
print("")
print("")
print("")
...
#issues here- looks like we need to remove "other" race samples
...
pathex.t.mpc<-mlogit(ajcc.path.t.recode ~  1 | PC1 + PC2+ PC3+ PC4+ PC5+ PC6+ PC7+ PC8+ PC9+ PC10+ PC11+ PC12+ PC13+ PC14+ PC15+ PC16+ PC17+ PC18+ PC19+PC20+PC21 + racerecode + age_centered, data=pathex.t.dpc2, reflevel = 1)
summary(pathex.t.mpc)

#singularity issues - remove "other" race and recode ajcc.t into 3 levels with less small cells and remove age from model
...
summary(corbatch20)
summary(corbatch21)
# 1,2,3,4,7,9,11,12,13,14,15,16,17,18,19,21
```
